...
(9, 8, 1, 0, '2019-01-25 07:49:32', '2019-02-03 06:36:54'),
...
CREATE TABLE `users` (
  ...
  `own_home` int(11) DEFAULT NULL,
  `own_car` int(11) DEFAULT NULL,
  `own_boat` tinyint(4) DEFAULT NULL COMMENT '0 means no 1 means yes',
  `expensive_jewelry` tinyint(4) DEFAULT NULL,
  `own_rental_property` tinyint(4) DEFAULT NULL,
  `own_small_business` tinyint(4) DEFAULT NULL COMMENT ' 0 means no 1 means yes ',
  `business_name` varchar(255) DEFAULT NULL,
  `married` tinyint(4) DEFAULT NULL COMMENT '0 means no 1 means yes',
  `how_many_children` int(11) DEFAULT NULL,
  `income_range` varchar(255) DEFAULT NULL,
  `net_worth_range` varchar(255) DEFAULT NULL,
  `health_assessment` varchar(255) DEFAULT NULL,
...
INSERT INTO `users` (`id`, `user_type_code`, `first_name`, `last_name`, `email`, `phone`, `account_type`, `address`, `city`, `state`, `zip`, `own_home`, `own_car`, `own_boat`, `expensive_jewelry`, `own_rental_property`, `own_small_business`, `business_name`, `married`, `how_many_children`, `income_range`, `net_worth_range`, `health_assessment`, `status`, `request_date`, `password`, `created`, `modified`) VALUES
(1, 'NORMAL', 'first name goof', 'boy here gg', 'rishi@test.com', '', 'business', 'sect4012', 'City1', 'State1', '122001', 0, NULL, 1, NULL, NULL, NULL, NULL, 0, NULL, '', '', '', 0, NULL, '$2y$10$xjzItDbKNjt4GnarNt/n5OD1lDiZXvIZJG9oJ/0zq6Oer.HZzhyf2', '0000-00-00 00:00:00', '2019-02-03 12:36:57'),
(2, 'NORMAL', '', '', 'vikajjjsh@test.com', '', 'individual', 'sect40', 'lko', 'hary', '122001', 2, 2, 1, 0, 0, 1, NULL, 1, 0, '', '', '', 0, NULL, '$2y$10$JaVaMUnNRX60rejeVr4K1ON5ZyRhTq5uMBcLcYnkzHkYvdhH7SO8O', '0000-00-00 00:00:00', '2019-01-01 10:09:16'),
(3, 'AGENT', '', '', 'raj@test.com', '', 'business', 'sect40', 'lko', 'hary', '122001', 2, 2, 1, 0, 0, 1, NULL, 0, 0, '', '', '', 0, NULL, '$2y$10$TxR/S/4XOvTPuSglCaI72enw7ZWBVuhtGW9A3i8mv9cpDKZ6hNpsq', '0000-00-00 00:00:00', '2019-01-25 12:35:31'),
(5, 'NORMAL', '', '', 'rish1i@test.com', '', '', '', '', '', '', 0, 0, 0, 0, 0, 0, NULL, 0, 0, '', '', '', 0, NULL, '$2y$10$UU44uaPsc7PG/QwSrfYdJO1uKomgtuNXkRK7BjiwpSsMgzTQiSmwq', '0000-00-00 00:00:00', '2019-01-06 13:59:07'),
(6, 'NORMAL', '', '', 'vikash@agent.com', '', 'agent', '', '', '', '', 0, 0, 0, 0, 0, 0, NULL, 0, 0, '', '', '', 0, NULL, '$2y$10$vnSb7f6Ya59Kn4cYA.tjPOyqR9YlwNzAAXJ1vSS/skV6MYXlvJXHS', '2019-01-24 11:36:10', '2019-01-24 11:36:10'),
(7, 'AGENT', '', '', 'rishi@agent.com', '', 'agent', '', '', '', '', 0, 0, 0, 0, 0, 0, NULL, 0, 0, '', '', '', 0, NULL, '$2y$10$LFQhpXBvJ7FxvB4juISNJuaGdETvwBOmeCCkCiffvw3vckoQ0y7E.', '2019-01-24 11:40:29', '2019-01-25 12:35:13'),
(10, 'AGENT', 'agent first rohit ', 'boy good', 'rohit@agent.com', '', 'individual', 'sect40', 'lko', 'hary', '122001', 3, 3, 0, 0, 0, 0, NULL, 0, 0, '', '', '', 0, NULL, '$2y$10$HIyyaZcZNdhl1UC4kuRk1OKCf0pARBAOrWcGZnvyfw8zaf5dTaN9q', '2019-01-24 11:59:50', '2019-01-31 10:36:51'),
(11, 'AGENT', '', '', 'jaidev@agent.com', '', 'agent', '', '', '', '', 0, 0, 0, 0, 0, 0, NULL, 0, 0, '', '', '', 0, NULL, '$2y$10$Wp8vJ6SyB17hzxVKE/DYceozT0yQ8722Fa/cdcbqzc1SC5fjwqTD6', '2019-01-24 12:01:31', '2019-01-25 12:34:50'),
(13, 'NORMAL', 'rajesh good', 'boy', 'firs22tuser@cust.com', '', '', 'sect40', 'lko', 'hary', '122001', 0, 0, 0, 0, 0, 0, NULL, 0, 0, '', '', '', 0, NULL, '$2y$10$2widfjIsN6X3Why4FeXHFudIxMxajdUL5gdDZ2sIiav50nDczai22', '2019-01-25 18:56:58', '2019-01-31 10:43:41'),
(14, 'NORMAL', 'aaacscxccxc', 'ddsasasa', 'rishicustagent@test.com', '', '', 'sect40', 'lko', 'hary', '122001', 0, 0, 0, 0, 0, 0, NULL, 0, 0, '', '', '', 0, NULL, '$2y$10$OAygotrpdlxLweumUmZXq.nYE1f/9LqwGp/ETA8a1Zi3X.XDsxzOO', '2019-01-26 11:48:16', '2019-01-31 10:48:57'),
(15, 'NORMAL', 'sasasas', 'aasasasa', 'jai@test.com', '', '', 'sect56', 'lko', 'up', '77382828', 0, 0, 0, 0, 0, 0, NULL, 0, 0, '', '', '', 0, NULL, '$2y$10$/sxKnWo9aFls/1VkrdR.0.NAcgRJX/vaUM3iaMEKBi6TpmWCb7G3u', '2019-01-26 12:01:41', '2019-01-31 10:47:05'),
(16, 'NORMAL', 'aaaaa', 'aaaaa', 'polo@yetet.com', '', '', 'sect56', 'lko', 'up', '77382828', 0, 0, 0, 0, 0, 0, NULL, 0, 0, '', '', '', 0, NULL, '$2y$10$Wa/PxW5g35ciRIi4k1yIGONYZSwQ8cUscFdaaOmq2fD/TLQBaUxv2', '2019-01-26 12:06:11', '2019-01-31 10:47:12'),
(17, 'NORMAL', '', '', 'kakakka@test.com', '', '', 'sect667', 'gutggag', 'up east', '77737373', 0, 0, 0, 0, 0, 0, NULL, 0, 0, '', '', '', 0, NULL, '$2y$10$1gwEuHuE0KOQj3rFWr1KmuMgRwymgDisv7TulOh2Kjlby2eEG.JSK', '2019-01-26 12:40:12', '2019-01-26 12:40:12'),
(18, 'NORMAL', '', '', 'jaipal@test.com', '', '', 'sec 67', 'lko', 'harynan', '292020', 0, 0, 0, 0, 0, 0, NULL, 0, 0, '', '', '', 0, NULL, '$2y$10$SZEYqg/ZkUbGdxAYYE1mrOhZjdWmfmr/CgJp4key5BK8tAKMac.J2', '2019-01-26 15:15:21', '2019-01-26 15:15:38'),
(19, 'AGENT', 'AgentVikash', 'Jain', 'jaipal@aganet.com', '', 'agent', 'Address', 'City', 'State', '1234', 0, 0, 0, 0, 0, 0, NULL, 0, 0, '', '', '', 0, NULL, '$2y$10$x9ckwXCYmBxFKt4nYJJIJ./KsYnfxVnUJmiqWCxTbSp3/bQJTTY9i', '2019-01-26 15:19:28', '2019-02-01 08:02:37'),
(20, 'NORMAL', '', '', 'pk@test.com', '', 'user', '', '', '', '', 0, 0, 0, 0, 0, 0, NULL, 0, 0, '', '', '', 0, NULL, '$2y$10$qbi3PngR14tLaljoDoezGu8kni8.5oM6aeVGVcrFR8TNAuYMwN1nS', '2019-01-26 15:20:23', '2019-01-26 15:20:23'),
(21, 'NORMAL', '', '', '', '', 'user', '', '', '', '', 0, 0, 0, 0, 0, 0, NULL, 0, 0, '', '', '', 0, NULL, '$2y$10$dJ8aN9t/mu3jg1zyzB0eme96Zm5YGktbgE8ana7LM.VDq6kfGf08u', '2019-02-03 07:25:39', '2019-02-03 07:25:39');
...
(38, 'PoliciesController', 'list', 'NORMAL', 1),
(39, 'UsersController', 'changepwd', 'NORMAL', 1),
(40, 'AgentsController', 'changepwd', 'AGENT', 1);
