<div class="col-md-2 leftMenuArea">
	<ul>
		...
		<li><?php echo $this->Html->link('Manage Account', array('controller' => 'users', 'action' => 'edit')); ?></li>		
		<li><?php echo $this->Html->link('Manage Policies', array('controller' => 'policies', 'action' => 'list')); ?></li>
